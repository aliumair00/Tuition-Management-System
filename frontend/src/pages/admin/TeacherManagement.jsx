        ...
        >
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-card-light dark:bg-card-dark p-4 rounded-xl border border-border-light dark:border-border-dark shadow-sm">
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">Manage all teacher records.</p>
                </div>
                <button
                        ...
                        <tbody>
                            {loading ? (
                                ...
                                teachers.map(teacher => (
                                    <tr key={teacher._id} className="border-b border-border-light dark:border-border-dark hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                        <td className="p-4 text-sm text-gray-800 dark:text-gray-200">{teacher.name}</td>
                                        <td className="p-4 text-sm text-gray-600 dark:text-gray-400">{teacher.email}</td>
                                        <td className="p-4 text-sm text-gray-600 dark:text-gray-400">{teacher.role}</td>
                                        <td className="p-4">
                                            <button onClick={() => handleDelete(teacher._id)} className="text-red-500 hover:text-red-700 p-2">
                                ...
                                <tr><td colSpan="4" className="p-4 text-center text-gray-500">No teachers found.</td></tr>
                            )}
                        </tbody>
                    </table>
                </div>
