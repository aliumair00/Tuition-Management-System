        ...
        >
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-card-light dark:bg-card-dark p-4 rounded-xl border border-border-light dark:border-border-dark shadow-sm sticky top-0 z-10">
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">Fill in the details below to add a new teacher.</p>
                </div>
            ...
            <motion.div variants={itemVariants} className="bg-card-light dark:bg-card-dark rounded-xl shadow-sm border border-border-light dark:border-border-dark p-6 md:p-8 space-y-8">
                ...
                <section>
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white pb-4 border-b border-border-light dark:border-border-dark mb-6">Professional Information</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <label className="space-y-2 md:col-span-2">
                            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Highest Qualification / Degree</span>
                            <div className="relative">
                                <input
                                    name="qualification"
                                    ...
                                    onChange={handleInputChange}
                                    type="text"
                                    placeholder="e.g., Master of Science in Education"
                                    className="w-full h-12 px-4 pl-11 rounded-lg bg-background-light dark:bg-gray-900 border border-border-light dark:border-gray-700 focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all"
                                />
                                <Briefcase className="absolute left-4 top-3.5 w-5 h-5 text-gray-400 pointer-events-none" />
                            </div>
                        </label>
                        <label className="space-y-2">
